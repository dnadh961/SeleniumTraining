...
public class ValidateAccount {
	...
	public void testCreateAccount(){
		...
		/*
		 * HomePage homePage = browser.open(); AuthenticationPage authenticationPage =
		 * homePage.signIn(); authenticationPage.enterEmailAddress(config.getEmail());
		 ...
		 * createAccountPage.setAddress(config.getFirstName(), config.getLastName(),
		 * config.getAddress(), "Woking", "1", "12345", "21", "07528016936",
		 * config.getAddress()); createAccountPage.register();
		 * Assert.assertTrue(createAccountPage.verifyElement(By.
